...
export const loadClassroom = () => async dispatch => {
    try {
        dispatch({
            type: types.CLASSROOM_LOAD_INIT,
        });
        const res = await api.load();
        if (res.data.error === false) {
            dispatch({
                type: types.CLASSROOM_LOAD_SUCCEED,
                payload: res.data.data,
            });
        } else {
            dispatch({
                type: types.CLASSROOM_LOAD_FAILED,
            });
        }
    } catch (error) {
        console.error(error);
...
export const createClassroom = classroom => async dispatch => {
    try {
        dispatch({
            type: types.ADD_CLASSROOM_INIT,
        });
        const res = await api.save(classroom);
        if (res.data.error === false) {
            dispatch({
                type: types.ADD_CLASSROOM_SUCCEED,
            });
        } else {
            dispatch({
                type: types.ADD_CLASSROOM_FAILED,
            });
        }
    } catch (error) {
        console.error(error);
...
export const deleteClassroom = id => async dispatch => {
    try {
        dispatch({
            type: types.DELETE_CLASSROOM_INIT,
        });

        const res = await api.remove(id);
        if (res.data.error === false) {
            dispatch({
                type: types.DELETE_CLASSROOM_SUCCEED,
            });
        } else {
            dispatch({
                type: types.DELETE_CLASSROOM_FAILED,
            });
        }
    } catch (error) {
        console.error(error);
...
export const loadClassroomById = id => async dispatch => {
    try {
        dispatch({
            type: types.CLASSROOM_ENTITY_LOAD_INIT,
        });
        const res = await api.loadById(id);
        if (res.data.error === false) {
            dispatch({
                type: types.CLASSROOM_ENTITY_LOAD_SUCCEED,
                payload: res.data.data,
            });
        } else {
            dispatch({
                type: types.CLASSROOM_ENTITY_LOAD_FAILED,
            });
        }
    } catch (error) {
        console.error(error);
...
export const loadClassroomNames = () => async dispatch => {
    try {
        dispatch({
            type: types.CLASSROOM_NAMES_LOAD_INIT,
        });
        const res = await api.loadNames();
        if (res.data.error === false) {
            dispatch({
                type: types.CLASSROOM_NAMES_LOAD_SUCCEED,
                payload: res.data.data,
            });
        } else {
            dispatch({
                type: types.CLASSROOM_NAMES_LOAD_FAILED,
            });
        }
    } catch (error) {
        console.error(error);
...
export const removeCourse = (course, day, id) => async dispatch => {
    try {
        dispatch({
            type: types.DELETE_COURSE_INIT,
        });

        const res = await api.removeCourse(course, day, id);
        if (res.data.error === false) {
            dispatch({
                type: types.DELETE_COURSE_SUCCEED,
            });
        } else {
            dispatch({
